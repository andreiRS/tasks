...
## Authoritative docs
- `README.md` — the command surface, flags, JSON shapes, and error codes. Source of truth for *what* and *how*.
...
- `docs/roadmap.md` — non-goals and consciously deferred decisions.
